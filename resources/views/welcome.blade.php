        ...
        <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center py-4 sm:pt-0">
            ...
            <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
                ...
                @if (Route::has('dealer.login'))
                    <div class="">
                        @auth('dealer')
                            <a href="{{ url('/dealer/dashboard') }}" class="text-sm text-gray-700 dark:text-gray-500 underline">Dealer Dashboard</a>
                        @else
                            <a href="{{ route('dealer.login') }}" class="text-sm text-gray-700 dark:text-gray-500 underline">Dealer Log in</a>

                            @if (Route::has('dealer.register'))
                                <a href="{{ route('dealer.register') }}" class="ml-4 text-sm text-gray-700 dark:text-gray-500 underline">Dealer Register</a>
                            @endif
                        @endauth
                    </div>
                @endif
                ...
                <a href="{{route('dealer.login')}}">Login Dealer</a>
                <a href="{{route('dealer.register')}}">Register Dealer</a>-->
            </div>
        </div>
    </body>
</html>
